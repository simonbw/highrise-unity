Shader "Sprite Unlit With Vision"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature _BLENDMODE_DEFAULT _BLENDMODE_ADD
            ...
            #include "./Include/CombinedShapeVisionShared.hlsl"
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                ...
                return CombinedShapeVisionShared(surfaceData, inputData);
            }
            ENDHLSL
        }
